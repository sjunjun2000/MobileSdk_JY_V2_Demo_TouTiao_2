...
public class GameAssistWindowManager implements OnFloatWindowTouchEvent {
	...
	public GameAssistWindowManager(Activity mActivity, FvItemClickListener listener){
	...
	private void setSmallWindowParams() {
	    if (this.smallWindowParams == null) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                this.smallWindowParams.type = WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY;
            } else {
	...
	private void setBrandWindowParams() {
		if (this.mBrandWindowParams == null) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                this.mBrandWindowParams.type = WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY;
            } else {
	...
	private void createBigWindow(float x, float y) {
	    if (this.mFloatWindowBigView == null) {
	        this.mFloatWindowBigView = new FloatWindowBigView(this.context, this, mListener);
	...
	private void setBigWindowParams(float smallX, float smallY) {
		if (this.bigWindowParams == null) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                this.bigWindowParams.type = WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY;
            } else {
