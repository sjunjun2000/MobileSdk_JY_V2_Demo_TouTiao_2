...
//  	private TextView pay_tv;
	...
	public FloatWindowBigView(Context context, OnFloatWindowTouchEvent mOnFloatWindowTouchEvent, FvItemClickListener listener) {
		super(context);
	...
	private void initView() {
	    ...
	    this.info_tv.setText("切换帐号"); // 个人信息
...
//	    this.message_tv.setText("自动登录");  // 消息
...
//			mListener.fvAutoLogin();
//		} else
		if (TextUtils.equals(tag, "uac_float_big_forum_ly")){
